...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_magout_01.ogg", t = 16/30},
			{s = path .. "wfoly_sm_augolf_reload_magout_cloth.ogg", t = 16/30},
			{s = path .. "wfoly_sm_augolf_reload_lower.ogg", t = 29/30},
			{s = path .. "wfoly_sm_augolf_reload_magin_cloth.ogg", t = 29/30},
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_empty_magout_01.ogg", t = 26/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magoutcloth.ogg", t = 33/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magincloth.ogg", t = 41/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magin_v2_01.ogg", t = 52/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magin_v2_02.ogg", t = 62/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_chamber_01.ogg", t = 76/30},
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_magin_cloth.ogg", t = 16/30},
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_augolf_reload_empty_mvmnt.ogg", t = 0/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magout_01.ogg", t = 5/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magoutcloth.ogg", t = 5/30},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_augolf_raise_first_chamber_01.ogg", t = 11/30},
...
SWEP.Attachments = {
    ...
    {
        PrintName = ARC9:GetPhrase("mw19_category_rails"),
