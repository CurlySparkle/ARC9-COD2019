...
SWEP.RangeMin = 12 / ARC9.HUToM --12
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sh_dpapa12_rechamber_chamber_v3_01a.ogg", t = 15/30},
			{s = path .. "wfoly_sh_dpapa12_rechamber_chamber_v3_02a.ogg", t = 20/30},
