...
SWEP.ShootSound = {path .. "weap_golf21_fire_plr_01.ogg", path .. "weap_golf21_fire_plr_02.ogg", path .. "weap_golf21_fire_plr_03.ogg", path .. "weap_golf21_fire_plr_04.ogg"}
SWEP.ShootSoundSilenced = {path .. "weap_golf21_fire_silenced_plr_01.ogg", path .. "weap_golf21_fire_silenced_plr_02.ogg", path .. "weap_golf21_fire_silenced_plr_03.ogg", path .. "weap_golf21_fire_silenced_plr_04.ogg"}
SWEP.ShootSoundIndoor = {path .. "weap_golf21_fire_plr_inside_01.ogg", path .. "weap_golf21_fire_plr_inside_02.ogg", path .. "weap_golf21_fire_plr_inside_03.ogg", path .. "weap_golf21_fire_plr_inside_04.ogg"}
SWEP.ShootSoundSilencedIndoor = {path .. "weap_golf21_fire_silenced_plr_inside_01.ogg", path .. "weap_golf21_fire_silenced_plr_inside_02.ogg", path .. "weap_golf21_fire_silenced_plr_inside_03.ogg", path .. "weap_golf21_fire_silenced_plr_inside_04.ogg"}
...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_golf21_reload_empty_magout_01.ogg", t = 5/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_magout_01.ogg", t = 5/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_down.ogg", t = 20/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_01.ogg", t = 46/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_magin_v2_01.ogg", t = 46/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_magin_v2_02.ogg", t = 54/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_magin_v2_02.ogg", t = 54/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_raise.ogg", t = 70/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_chamber_01.ogg", t = 70/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_chamber_01.ogg", t = 73/30},
			{s = path .. "wfoly_pi_golf21_reload_empty_fast_end.ogg", t = 83/30},
        },
    },
    ["ready"] = {
        Source = "draw",
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_pi_golf21_first_raise_slide_release.ogg", t = 18/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
