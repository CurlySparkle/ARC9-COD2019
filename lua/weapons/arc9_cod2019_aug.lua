...
SWEP.Animations = {
    ...
    ["reload_armag"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_waffle_end.ogg", t = 52/30},
        },
    },
    ["reload_armag_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_waffle_magout_01.ogg", t = 27/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magoutcloth.ogg", t = 34/30},
			{s = path .. "wfoly_sm_augolf_reload_empty_magincloth.ogg", t = 40/30},
			{s = path .. "wfoly_sm_augolf_reload_waffle_magin_v2_01.ogg", t = 54/30},
			{s = path .. "wfoly_sm_augolf_reload_waffle_magin_v2_02.ogg", t = 62/30},
    ...
    ["reload_armag_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_fast_waffle_magout_01.ogg", t = 13/30},
            {s = path .. "wfoly_sm_augolf_reload_fast_waffle_mvmnt.ogg", t = 18/30},
			{s = path .. "wfoly_sm_augolf_reload_lower.ogg", t = 26/30},
			{s = path .. "wfoly_sm_augolf_reload_magin_cloth.ogg", t = 27/30},
			{s = path .. "wfoly_sm_augolf_reload_fast_waffle_magin.ogg", t = 29/30},
			{s = path .. "wfoly_sm_augolf_reload_fast_waffle_end.ogg", t = 39/30},
        },
    },
    ["reload_armag_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_empty_magincloth.ogg", t = 19/30},
			{s = path .. "wfoly_sm_augolf_reload_fast_waffle_magin.ogg", t = 29/30},
