...
SWEP.Animations = {
    ...
    ["reload_glaunch"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_gl_rotate.ogg", t = 0.033},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magout.ogg", t = 0.6},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magin_v2_01.ogg", t = 1.1},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magin_v2_02.ogg", t = 1.4},
			{s = path .. "wfoly_ar_scharlie_reload_gl_end.ogg", t = 1.66},
			{hide = 1, t = 0},
			{hide = 0, t = 0.375},
			{hide = 2, t = 1.7},
			{hide = 1, t = 2.36},
    ...
    ["reload_empty_glaunch"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_scharlie_reload_gl_rotate.ogg", t = 0.066},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magout.ogg", t = 0.46},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magin_v2_01.ogg", t = 1.46},
			{s = path .. "wfoly_ar_scharlie_reload_gl_magin_v2_02.ogg", t = 1.76},
			{s = path .. "wfoly_ar_scharlie_reload_empty_bolt_release.ogg", t = 2.16},
			{s = path .. "wfoly_ar_scharlie_reload_empty_end.ogg", t = 2.23},
			{hide = 1, t = 0},
			{hide = 3, t = 0.9},
