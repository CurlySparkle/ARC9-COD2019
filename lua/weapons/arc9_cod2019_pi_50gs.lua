...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_decho_reload_xmag_raise.ogg", t = 1/30},
			{s = path .. "wfoly_pi_decho_reload_xmag_magout_01.ogg", t = 18/30},
			{s = path .. "wfoly_pi_decho_reload_xmag_magin_v2_01.ogg", t = 27/30},
			{s = path .. "wfoly_pi_decho_reload_xmag_magin_v2_02.ogg", t = 37/30},
			{s = path .. "wfoly_pi_decho_reload_xmag_end.ogg", t = 41/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 1.55}
        },
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_shake.ogg", t = 0/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_magout_01.ogg", t = 5/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_magin_v2_01.ogg", t = 24/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_magin_v2_02.ogg", t = 31/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_grab.ogg", t = 32/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_charge_01.ogg", t = 44/30},
			{s = path .. "wfoly_pi_decho_reload_empty_xmag_end.ogg", t = 44/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.45},
			{hide = 1, t = 1.766}
        },
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_pi_decho_fast_reload_xmag_raise.ogg", t = 0/30},
			{s = path .. "wfoly_pi_decho_fast_reload_xmag_magout_01.ogg", t = 3/30},
			{s = path .. "wfoly_pi_decho_fast_reload_xmag_magin_v2_01.ogg", t = 13/30},
            {s = path .. "wfoly_pi_decho_fast_reload_xmag_mvmnt.ogg", t = 18/30},
			{s = path .. "wfoly_pi_decho_fast_reload_xmag_magin_v2_02.ogg", t = 20/30},
            {s = path .. "wfoly_pi_decho_fast_reload_xmag_end.ogg", t = 27/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.425}
        },
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_pi_decho_fast_reload_empty_magin_v2_01.ogg", t = 14/30},
			{s = path .. "wfoly_pi_decho_fast_reload_empty_magin_v2_02.ogg", t = 20/30},
			{s = path .. "wfoly_pi_decho_fast_reload_empty_slide_01.ogg", t = 24/30},
			{s = path .. "wfoly_pi_decho_fast_reload_empty_end.ogg", t = 29/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.425}
        },
