...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(1, 2.25, -1.5),
}
...
SWEP.CustomizePos = Vector(20.5, 45, 4)
SWEP.CustomizeRotateAnchor = Vector(20.5, -4, -4)
SWEP.CustomizeSnapshotFOV = 65
SWEP.CustomizeSnapshotPos = Vector(0, 55, 0)
SWEP.CustomizeSnapshotAng = Angle(0, 0, 0)
SWEP.CustomizeNoRotate = false

SWEP.PeekPos = Vector(-1.5, 4, -4.5)
...
SWEP.ReloadHideBoneTables = {
    [1] = {
        "j_mag2",
		"j_empty_ammo_belt_01",
		"j_empty_ammo_belt_02",
		"j_empty_ammo_belt_03"
    },
	[2] = {
        "j_mag2",
		"j_empty_ammo_belt_01",
