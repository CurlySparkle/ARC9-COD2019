...
SWEP.WorldModelOffset = {
    Pos = Vector(-10, 3.75, -5.5),
    Ang = Angle(-5, 0, 180),
    TPIKPos = Vector(-12, 5.5, -4),
    TPIKAng = Angle(-12.5, -1, 165),
    Scale = 1,
	
	TPIKPosSightOffset = Vector(1, 0.5, -1),
}
...
SWEP.RangeMax = 26 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.CustomizePos = Vector(11, 30, 3.5)
SWEP.CustomizeRotateAnchor = Vector(12, -3.25, -4)
...
SWEP.TriggerDownSound = path .. "weap_papa90_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_papa90_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_papa90_raise_first_charge_01.ogg", t = 0.35},
