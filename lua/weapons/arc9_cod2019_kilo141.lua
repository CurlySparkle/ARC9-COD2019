...
SWEP.SpreadAddShooting = 0.04 -- Applied per unit of recoil.
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_kilo433_reload_end.ogg", t = 61/30},
        },
    },
    ["1_reload"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_magin_v2_01.ogg", t = 25/30},
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_magin_v2_02.ogg", t = 30/30},
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_end.ogg", t = 70/30},
        },
    },
    ["ready"] = {
        Source = "draw",
