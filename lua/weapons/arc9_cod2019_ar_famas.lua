...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(1, 2, -1.25),
}
...
SWEP.TriggerDownSound = path .. "weap_falpha_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_falpha_disconnector_plr_01.ogg"
