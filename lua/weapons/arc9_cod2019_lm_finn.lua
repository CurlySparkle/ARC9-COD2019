...
SWEP.CustomizePos = Vector(15, 40, 3)
...
SWEP.TriggerDownSound = path .. "weap_sierrax_prefire_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_sierrax_disconnector_plr_01.ogg"
