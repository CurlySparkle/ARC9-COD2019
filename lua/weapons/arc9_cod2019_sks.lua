...
SWEP.ShootSound = {path .. "weap_sksierra_fire_bang_plr_01.ogg", path .. "weap_sksierra_fire_bang_plr_02.ogg", path .. "weap_sksierra_fire_bang_plr_03.ogg", path .. "weap_sksierra_fire_bang_plr_04.ogg"}
SWEP.ShootSoundSilenced = {path .. "weap_sksierra_fire_bang_silenced_plr_01.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_02.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_03.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_04.ogg"}
SWEP.ShootSoundIndoor = {path .. "weap_sksierra_fire_bang_plr_inside_01.ogg", path .. "weap_sksierra_fire_bang_plr_inside_02.ogg", path .. "weap_sksierra_fire_bang_plr_inside_03.ogg", path .. "weap_sksierra_fire_bang_plr_inside_04.ogg"}
SWEP.ShootSoundSilencedIndoor = {path .. "weap_sksierra_fire_bang_silenced_plr_inside_01.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_inside_02.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_inside_03.ogg", path .. "weap_sksierra_fire_bang_silenced_plr_inside_04.ogg"}
