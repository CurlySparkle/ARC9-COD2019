...
SWEP.ShootSound = {path .. "weap_lmg_fire_layer_plr_01.ogg", path .. "weap_lmg_fire_layer_plr_02.ogg", path .. "weap_lmg_fire_layer_plr_03.ogg", path .. "weap_lmg_fire_layer_plr_04.ogg", path .. "weap_lmg_fire_layer_plr_05.ogg", path .. "weap_lmg_fire_layer_plr_06.ogg"}
SWEP.ShootSoundIndoor = {path .. "weap_lmg_fire_layer_plr_inside_01.ogg", path .. "weap_lmg_fire_layer_plr_inside_02.ogg", path .. "weap_lmg_fire_layer_plr_inside_03.ogg", path .. "weap_lmg_fire_layer_plr_inside_04.ogg", path .. "weap_lmg_fire_layer_plr_inside_05.ogg"}
