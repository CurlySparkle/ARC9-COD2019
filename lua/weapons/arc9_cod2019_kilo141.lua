...
SWEP.ShootSoundIndoor = {path .. "weap_kilo433_fire_plr_inside_01.ogg", path .. "weap_kilo433_fire_plr_inside_02.ogg", path .. "weap_kilo433_fire_plr_inside_03.ogg", path .. "weap_kilo433_fire_plr_inside_04.ogg"}
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_kilo433_reload_magin_v2_02.ogg", t = 43/30},
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_magin_v2_02.ogg", t = 27/30},
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_magout_01.ogg", t = 3/30},
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_reach.ogg", t = 5/30},
			{s = path .. "wfoly_plr_ar_kilo433_reload_empty_tilt.ogg", t = 15/30},
    ...
    ["holster"] = {
		...
		Mult = 0.7,
        EventTable = {
            {s = path .. "wfoly_plr_ar_kilo433_reload_end.ogg", t = 0/30},
        },
    },
    ["idle"] = {
        Source = "idle",
