...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sn_xmike109_reload_fast_magout.ogg", t = 17/30},
			{s = path .. "wfoly_sn_xmike109_reload_fast_arm.ogg", t = 38/30},
			{s = path .. "wfoly_sn_xmike109_reload_fast_magin_01.ogg", t = 48/30},
			{s = path .. "wfoly_sn_xmike109_reload_fast_magin_02.ogg", t = 58/30},
			{s = path .. "wfoly_sn_xmike109_reload_fast_end.ogg", t = 71/30},
        },
    },
    ["reload_empty"] = {
        Source = "reload",
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sn_xmike109_reload_empty_fast_grab.ogg", t = 12/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_magout.ogg", t = 18/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_arm.ogg", t = 40/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_magin_01.ogg", t = 50/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_magin_02.ogg", t = 59/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_boltpull.ogg", t = 81/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_boltrelease.ogg", t = 98/30},
			{s = path .. "wfoly_sn_xmike109_reload_empty_fast_end.ogg", t = 107/30},
        },
    },
    ["ready"] = {
        Source = "draw",
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sn_xmike109_first_raise_bolt_pull.ogg", t = 19/30},
            {s = path .. "wfoly_sn_xmike109_first_raise_bolt_release.ogg", t = 31/30},
