...
SWEP.PeekPos = Vector(-1.5, 2.5, -3.5)
...
SWEP.Animations = {
	...
	["reload_xmag"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_reload_xmag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_top_cover_open.ogg", t = 26/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_clean_tray.ogg", t = 34/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_open_tray.ogg", t = 54/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_close_tray.ogg", t = 73/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_magout.ogg", t = 85/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_raise.ogg", t = 108/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_maghit.ogg", t = 125/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_magin.ogg", t = 149/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_settle.ogg", t = 160/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_bullets_into_tray.ogg", t = 169/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_top_cover_close.ogg", t = 209/30},
			{s = path .. "wfoly_lm_slima_reload_xmag_end.ogg", t = 212/30},
			{hide = 1, t = 0},
			{hide = 2, t = 1.4},
			{hide = 3, t = 1.45},
			{hide = 2, t = 1.9},
	...
	["reload_xmag_empty"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_lower.ogg", t = 1/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_bolt_pull.ogg", t = 18/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_bolt_close.ogg", t = 29/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_top_cover_open.ogg", t = 62/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_tray_open.ogg", t = 77/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_tray_close.ogg", t = 93/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_magout.ogg", t = 105/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_maghit.ogg", t = 147/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_magin.ogg", t = 163/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_bullets_into_tray.ogg", t = 187/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_top_cover_close.ogg", t = 224/30},
			{s = path .. "wfoly_lm_slima_reload_empty_xmag_end.ogg", t = 244/30},
			{hide = 6, t = 0},
			{hide = 7, t = 3},
			{hide = 5, t = 4},
			{hide = 1, t = 4.7},
	...
	["reload_xmag_fast"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_top_cover_pop.ogg", t = 17/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_clean_tray.ogg", t = 25/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_magout.ogg", t = 51/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_raise.ogg", t = 76/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_maghit.ogg", t = 99/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_magin.ogg", t = 103/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_bullets_into_tray.ogg", t = 121/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_top_cover_close.ogg", t = 151/30},
			{s = path .. "wfoly_lm_slima_reload_fast_xmag_end.ogg", t = 167/30},
			{hide = 1, t = 0},
			{hide = 4, t = 1.33},
			{hide = 5, t = 2},
			{hide = 1, t = 2.75},
	...
	["reload_xmag_fast_empty"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_bolt_pull.ogg", t = 17/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_bolt_close.ogg", t = 27/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_top_cover_pop.ogg", t = 41/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_magout.ogg", t = 59/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_maghit.ogg", t = 94/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_magin.ogg", t = 117/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_bullets_into_tray.ogg", t = 135/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_top_cover_close.ogg", t = 162/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_xmag_end.ogg", t = 179/30},
			{hide = 6, t = 0},
			{hide = 5, t = 2.6},
			{hide = 1, t = 3.1},
			{hide = 8, t = 5},
    ...
    ["reload_smag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_slima_reload_smag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_smag_top_cover_open.ogg", t = 15/30},
			{s = path .. "wfoly_lm_slima_reload_smag_clean_tray.ogg", t = 34/30},
			{s = path .. "wfoly_lm_slima_reload_smag_tray_open.ogg", t = 53/30},
			{s = path .. "wfoly_lm_slima_reload_smag_tray_close.ogg", t = 65/30},
			{s = path .. "wfoly_lm_slima_reload_smag_magout.ogg", t = 74/30},
			{s = path .. "wfoly_lm_slima_reload_smag_maghit.ogg", t = 89/30},
			{s = path .. "wfoly_lm_slima_reload_smag_magin.ogg", t = 107/30},
			{s = path .. "wfoly_lm_slima_reload_smag_bullets_into_tray.ogg", t = 125/30},
			{s = path .. "wfoly_lm_slima_reload_smag_top_cover_close.ogg", t = 160/30},
			{s = path .. "wfoly_lm_slima_reload_smag_end.ogg", t = 167/30},
			{hide = 1, t = 0},
			{hide = 9, t = 1.33},
			{hide = 10, t = 1.45},
			{hide = 9, t = 1.85},
    ...
    ["reload_smag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_slima_reload_empty_smag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_bolt_pull.ogg", t = 18/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_bolt_close.ogg", t = 26/30},
			{s = path .. "wfoly_lm_slima_reload_empty_clean_tray.ogg", t = 51/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_magout.ogg", t = 95/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_maghit.ogg", t = 114/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_magin.ogg", t = 126/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_bullets_into_tray.ogg", t = 144/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_top_cover_close.ogg", t = 179/30},
			{s = path .. "wfoly_lm_slima_reload_empty_smag_end.ogg", t = 188/30},
			{hide = 6, t = 0},
			{hide = 7, t = 2.75},
			{hide = 5, t = 3.5},
			{hide = 1, t = 3.75},
    ...
    ["reload_smag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_slima_reload_fast_smag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_top_cover_open.ogg", t = 18/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_clean_tray.ogg", t = 31/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_magout.ogg", t = 51/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_maghit.ogg", t = 73/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_magin.ogg", t = 86/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_bullets_into_tray.ogg", t = 98/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_top_cover_close.ogg", t = 121/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_end.ogg", t = 139/30},
			{hide = 1, t = 0},
			{hide = 11, t = 1.3},
			{hide = 5, t = 1.8},
			{hide = 1, t = 2.4},
    ...
    ["reload_smag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_lower.ogg", t = 3/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_bolt_pull.ogg", t = 14/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_bolt_close.ogg", t = 21/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_top_cover_pop.ogg", t = 45/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_top_cover_open.ogg", t = 61/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_maghit.ogg", t = 83/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_magin.ogg", t = 87/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_tray_open.ogg", t = 105/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_bullets_into_tray.ogg", t = 109/30},
			{s = path .. "wfoly_lm_slima_reload_empty_fast_smag_tray_close.ogg", t = 132/30},
			{s = path .. "wfoly_lm_slima_reload_fast_smag_end.ogg", t = 140/30},
			{hide = 6, t = 0},
			{hide = 5, t = 2.15},
			{hide = 1, t = 2.5},
			{hide = 8, t = 3.9},
    ...
    ["inspect"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_lm_slima_inspect_02.ogg", t = 26/30},
			{s = path .. "wfoly_lm_slima_inspect_03.ogg", t = 48/30},
			{s = path .. "wfoly_lm_slima_inspect_04.ogg", t = 80/30},
			{s = path .. "wfoly_lm_slima_inspect_05.ogg", t = 122/30},
			{s = path .. "wfoly_lm_slima_inspect_06.ogg", t = 169/30},
        },
    },
	["inspect_smag"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_inspect_smag_lower.ogg", t = 0/30},
			{s = path .. "wfoly_lm_slima_inspect_smag_top_cover_open.ogg", t = 26/30},
			{s = path .. "wfoly_lm_slima_inspect_smag_top_cover_close.ogg", t = 50/30},
			{s = path .. "wfoly_lm_slima_inspect_smag_lift.ogg", t = 82/30},
			{s = path .. "wfoly_lm_slima_inspect_smag_rotate.ogg", t = 116/30},
			{s = path .. "wfoly_lm_slima_inspect_smag_end.ogg", t = 177/30},
		},
	},
	["inspect_xmag"] = {
		...
		EventTable = {
			{s = path .. "wfoly_lm_slima_inspect_xmag_lower.ogg", t = 6/30},
			{s = path .. "wfoly_lm_slima_inspect_xmag_top_cover_open.ogg", t = 27/30},
			{s = path .. "wfoly_lm_slima_inspect_xmag_top_cover_close.ogg", t = 60/30},
			{s = path .. "wfoly_lm_slima_inspect_xmag_lift.ogg", t = 79/30},
			{s = path .. "wfoly_lm_slima_inspect_xmag_rotate.ogg", t = 123/30},
			{s = path .. "wfoly_lm_slima_inspect_xmag_end.ogg", t = 175/30},
		},
	},
    ["bash"] = {
...
SWEP.Attachments = {
    { -- 1
        ...
        Category = {"cod2019_muzzle", "cod2019_raal_muzzle"},
