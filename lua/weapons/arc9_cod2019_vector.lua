...
SWEP.ShootSound = {path .. "weap_victor_fire_plr_01.ogg", path .. "weap_victor_fire_plr_02.ogg", path .. "weap_victor_fire_plr_03.ogg", path .. "weap_victor_fire_plr_04.ogg"}
SWEP.ShootSoundSilenced = {path .. "weap_victor_fire_silenced_plr_01.ogg", path .. "weap_victor_fire_silenced_plr_02.ogg", path .. "weap_victor_fire_silenced_plr_03.ogg", path .. "weap_victor_fire_silenced_plr_04.ogg"}
SWEP.ShootSoundIndoor = {path .. "weap_victor_fire_plr_inside_01.ogg", path .. "weap_victor_fire_plr_inside_02.ogg", path .. "weap_victor_fire_plr_inside_03.ogg", path .. "weap_victor_fire_plr_inside_04.ogg"}
SWEP.ShootSoundSilencedIndoor = {path .. "weap_victor_fire_silenced_plr_inside_01.ogg", path .. "weap_victor_fire_silenced_plr_inside_02.ogg", path .. "weap_victor_fire_silenced_plr_inside_03.ogg", path .. "weap_victor_fire_silenced_plr_inside_04.ogg"}
...
SWEP.Animations = {
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_victor_reload_empty_arm.ogg", t = 22/30},
			{s = path .. "wfoly_sm_victor_reload_empty_rotate.ogg", t = 28/30},
			{s = path .. "wfoly_sm_victor_reload_empty_maghit.ogg", t = 38/30},
			{s = path .. "wfoly_sm_victor_reload_empty_magin_01.ogg", t = 40/30},
			{s = path .. "wfoly_sm_victor_reload_empty_magin_02.ogg", t = 41/30},
    ...
    ["switchsights"] = {
        Source = "semi_on",
        EventTable = {
            {s = path .. "wfoly_plr_sm_victor_inspect_02.ogg", t = 0/30},
        },
    },
}
