...
SWEP.Trivia = {
    ...
    [ ARC9:GetPhrase("mw19_weight") ] = "3.63 kg",
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_lm_mgolf36_raise_first_bolt_pull.ogg", t = 22/30},
			{s = path .. "wfoly_lm_mgolf36_raise_first_bolt_release.ogg", t = 39/30},
