...
L["mw19_weapon_kar98_desc"] = "7.92モーゼル弾のボルトアクションライフル。第二次世界大戦の遺物だが反抗心のあるマークスマンが握れば今でも非常に強力"
...
L["mw19_weapon_nade_claymore_desc"] = "敵が近づくと爆発する地雷" .. quicknade
L["mw19_weapon_nade_frag_desc"] = "爆破のタイミングが調整可能なグレネード" .. quicknade
L["mw19_weapon_nade_molotov_desc"] = "着弾時に爆発する強化焼夷弾" .. quicknade
-- L["mw19_weapon_nade_c4_desc"] = "対象の表面に張り付く大型爆薬。装備が枯渇した場合に{ATTACK}を使用して起爆させることができる。\n\n{USE}をダブルタップすると必ず起爆する"
L["mw19_weapon_nade_c4_desc"] = "対象の表面に張り付く大型爆薬。装備が枯渇した場合に{ATTACK}を使用して起爆させることができる。" .. quicknade
L["mw19_weapon_nade_semtex_desc"] = "時限式の粘着グレネード" .. quicknade
...
L["mw19_weapon_nade_smoke_desc"] = "視界を遮り自動照準システムを妨げる煙幕を展開" .. quicknade
L["mw19_weapon_nade_snapshot_desc"] = "範囲内にいる敵の情報を一定時間取得" .. quicknade
L["mw19_weapon_nade_heartbeat_desc"] = "付近の敵の大まかな情報を表示するタブレット端末" .. quicknade
L["mw19_weapon_nade_stim_desc"] = "傷口を焼灼し、タクティカルダッシュを可能にする軍人用の興奮剤" .. quicknade
L["mw19_weapon_nade_decoy_desc"] = "発砲やレーダー信号を偽装して敵をかく乱する防諜装置" .. quicknade
L["mw19_weapon_nade_gas_desc"] = "着弾と同時に催涙ガスを放出。敵は咳込み、視界がぼやけ、移動速度が低下" .. quicknade
