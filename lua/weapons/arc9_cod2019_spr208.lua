...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sn_remeo700_reload_maghit.ogg", t = 30/30},
            {s = path .. "wfoly_sn_remeo700_reload_end.ogg", t = 36/30},
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sn_remeo700_reload_empty_rotate.ogg", t = 42/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_boltopen.ogg", t = 44/30},
            {s = path .. "wfoly_sn_remeo700_reload_empty_boltclose.ogg", t = 64/30},
        },
    },
    ["reload_xmag"] = {
        Source = "reload_xmag",
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sn_remeo700_reload_up.ogg", t = 0/30},
			{s = path .. "wfoly_sn_remeo700_reload_magout.ogg", t = 19/30},
			{s = path .. "wfoly_sn_remeo700_reload_maghit.ogg", t = 37/30},
            {s = path .. "wfoly_sn_remeo700_reload_end.ogg", t = 39/30},
			{s = path .. "wfoly_sn_remeo700_reload_magin.ogg", t = 43/30},
        },
    },
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sn_remeo700_raise_first_up.ogg", t = 0/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_magout.ogg", t = 20/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_maghit.ogg", t = 37/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_magin.ogg", t = 44/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_rotate.ogg", t = 48/30},
			{s = path .. "wfoly_sn_remeo700_reload_empty_boltopen.ogg", t = 50/30},
            {s = path .. "wfoly_sn_remeo700_reload_empty_boltclose.ogg", t = 68/30},
        },
    },
    ["ready"] = {
        Source = "draw",
