...
SWEP.DistantShootSound = path .. "weap_xmike109_fire_plr_01_01.ogg"
SWEP.DistantShootSoundSilenced = path .. "weap_xmike109_sup_plr_01_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_xmike109_reload_up.ogg", t = 0/30},
			{s = path .. "wfoly_sn_xmike109_reload_magout.ogg", t = 11/30},
