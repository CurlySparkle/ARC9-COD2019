...
SWEP.WorldModelOffset = {
    Pos = Vector(-5, 3.5, -6.75),
    Ang = Angle(-5, 0, 180),
    TPIKPos = Vector(-8.5, 4, -4),
    TPIKAng = Angle(-12.5, -1, 165),
    Scale = 1,
	
	TPIKPosSightOffset = Vector(2, 1, -1),
}
...
SWEP.CustomizePos = Vector(14.5, 40, 3)
...
SWEP.TriggerDownSound = path .. "weap_mgolf36_fire_first_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_mgolf36_disconnector_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload_ar"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_mgolf36_reload_lift.ogg", t = 3/30},
			{s = path .. "wfoly_lm_mgolf36_reload_armag_magout.ogg", t = 22/30},
    ...
    ["reload_ar_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_lm_mgolf36_reload_fast_armag_magout.ogg", t = 13/30},
    ...
    ["reload_ar_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_lm_mgolf36_reload_empty_fast_armag_lift.ogg", t = 3/30},
			{s = path .. "wfoly_lm_mgolf36_reload_empty_fast_armag_magout.ogg", t = 14/30},
			{s = path .. "wfoly_lm_mgolf36_reload_empty_fast_armag_mag_hit_well.ogg", t = 29/30},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_lm_mgolf36_raise_first_bolt_pull.ogg", t = 20.5/30},
			{s = path .. "wfoly_lm_mgolf36_raise_first_bolt_release.ogg", t = 37.5/30},
