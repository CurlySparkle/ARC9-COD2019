...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_arm.ogg", t = 9/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_magout_01.ogg", t = 11/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_thumb.ogg", t = 20/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_magin_v2_01.ogg", t = 26/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_magin_v2_02.ogg", t = 30/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_wiggle.ogg", t = 34/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_xmag_end.ogg", t = 41/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.275},
			{hide = 2, t = 1.325},
        },
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_magout_01.ogg", t = 10/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_regrip.ogg", t = 15/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_arm.ogg", t = 30/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_magin_v2_01.ogg", t = 32/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_magin_v2_02.ogg", t = 39/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_charge_01.ogg", t = 49/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_xmag_end.ogg", t = 50/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.6},
			{hide = 1, t = 0.9},
        },
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_pi_papa320_reload_fast_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_fast_xmag_magout_01.ogg", t = 6/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_fast_xmag_arm.ogg", t = 11/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_fast_xmag_magin_01.ogg", t = 15.5/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_fast_xmag_end.ogg", t = 19/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.4},
        },
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_magout_01.ogg", t = 7/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_arm.ogg", t = 12/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_magin_01.ogg", t = 15/30},
            {s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_charge_01.ogg", t = 25/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_fast_xmag_end.ogg", t = 25/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 0.4},
        },
