...
SWEP.Animations = {
    ...
    ["reload_armag_fast"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_augolf_reload_fast_waffle_mvmnt.ogg", t = 15/30},
			{s = path .. "wfoly_sm_augolf_reload_lower.ogg", t = 25/30},
			{s = path .. "wfoly_sm_augolf_reload_magin_cloth.ogg", t = 26/30},
