...
SWEP.Animations = {
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_plr_pi_papa320_reload_empty_end.ogg", t = 50/30},
        },
    },
    ["reload_fast"] = {
        Source = "reload_fast",
        ...
        EventTable = {
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_magout_01.ogg", t = 6/30},
			...
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_end.ogg", t = 18/30},
        },
    },
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_magin_v2_01.ogg", t = 15/30},
			{s = path .. "wfoly_plr_pi_papa320_reload_empty_magin_v2_02.ogg", t = 18/30},
            {s = path .. "wfoly_plr_pi_papa320_reload_empty_end.ogg", t = 22/30},
