...
SWEP.PrintName = ARC9:GetPhrase("mw19_weapon_mp7") or "MP7"
...
SWEP.RangeMax = 25 / ARC9.HUToM -- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.IronSights = {
    Pos = Vector(-2.71, -3.5, 0.35),
    Ang = Angle(-0.15, 0.4, 2.1),
    Magnification = 1.15,
    ViewModelFOV = 56,
...
SWEP.CustomizePos = Vector(11, 32.5, 4)
...
SWEP.TriggerDownSound = path .. "weap_mpapa7_fire_first_plr_01.ogg"
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_mpapa7_reload_lift.ogg", t = 0.033},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_mag_release.ogg", t = 0.4},
            {s = path .. "wfoly_plr_sm_mpapa7_reload_mvmnt.ogg", t = 0.533},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_magout.ogg", t = 0.767},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_magin_v2_01.ogg", t = 1.2},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_magin_v2_02.ogg", t = 1.433},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_end.ogg", t = 1.7},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 1.7},
			{hide = 1, t = 2.05},
    ...
    ["reload_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_lift.ogg", t = 0.033},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_magout.ogg", t = 0.367},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_magin_v2_01.ogg", t = 0.9},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_magin_v2_02.ogg", t = 1.267},
            {s = path .. "wfoly_plr_sm_mpapa7_reload_empty_mvmnt.ogg", t = 1.4},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_bolt_release.ogg", t = 1.533},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_end.ogg", t = 1.9},
			{hide = 1, t = 0},
			{hide = 3, t = 0.625},
			{hide = 1, t = 0.675},
        },
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_mpapa7_reload_fast_lift.ogg", t = 0.0},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_fast_magout.ogg", t = 0.4},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_fast_magin_v2_01.ogg", t = 1.0},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_fast_magin_v2_02.ogg", t = 1.11},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_fast_end.ogg", t = 1.4},
			{hide = 1, t = 0},
			{hide = 3, t = 0.49},
			{hide = 1, t = 0.55},
        },
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_lift.ogg", t = 0.033},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_magout.ogg", t = 0.3},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_magin_v2_01.ogg", t = 0.8},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_magin_v2_02.ogg", t = 1.067},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_bolt_release.ogg", t = 1.333},
			{s = path .. "wfoly_plr_sm_mpapa7_reload_empty_fast_end.ogg", t = 1.4},
			{hide = 1, t = 0},
			{hide = 3, t = 0.49},
			{hide = 1, t = 0.55},
        },
    ...
    ["inspect"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_mpapa7_inspect_02.ogg", t = 1.1},
			{s = path .. "wfoly_sm_mpapa7_inspect_03.ogg", t = 1.867},
			{s = path .. "wfoly_sm_mpapa7_inspect_04.ogg", t = 2.633},
			{s = path .. "wfoly_sm_mpapa7_inspect_04.ogg", t = 3.6},
        },
    },
    ["bash"] = {
...
SWEP.Hook_TranslateAnimation = function(wep, anim)
    ...
    if mmag and speedload and Translate_MMag_Fast[anim] then
        return Translate_MMag_Fast[anim]
    elseif mmag and Translate_MMag[anim] then
