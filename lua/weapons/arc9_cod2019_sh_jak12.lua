...
SWEP.Animations = {
    ...
    ["reload_drum"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_aalpha12_reload_drum_raise.ogg", t = 0/30},
			{s = path .. "wfoly_sh_aalpha12_reload_drum_magout.ogg", t = 9/30},
			{s = path .. "wfoly_sh_aalpha12_reload_drum_maghit.ogg", t = 37/30},
			{s = path .. "wfoly_sh_aalpha12_reload_drum_magin.ogg", t = 48/30},
            {s = path .. "wfoly_sh_aalpha12_reload_drum_mvmnt.ogg", t = 58/30},
			{s = path .. "wfoly_sh_aalpha12_reload_drum_end.ogg", t = 71/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.7},
			{hide = 1, t = 1.1},
        },
    ...
    ["reload_drum_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_boltpull.ogg", t = 0/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_magout.ogg", t = 23/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_maghit.ogg", t = 50/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_magin.ogg", t = 61/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_boltforward.ogg", t = 73/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_drum_end.ogg", t = 95/30},
			{hide = 1, t = 0},
			{hide = 3, t = 1.1},
			{hide = 1, t = 1.4},
        },
    ...
    ["reload_drum_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_aalpha12_reload_fast_drum_magout.ogg", t = 0/30},
			{s = path .. "wfoly_sh_aalpha12_reload_fast_drum_mvnt.ogg", t = 12/30},
			{s = path .. "wfoly_sh_aalpha12_reload_fast_drum_maghit.ogg", t = 33/30},
			{s = path .. "wfoly_sh_aalpha12_reload_fast_drum_magin.ogg", t = 39/30},
			{s = path .. "wfoly_sh_aalpha12_reload_fast_drum_end.ogg", t = 50/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.5},
			{hide = 1, t = 0.75},
        },
    ...
    ["reload_drum_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_raise.ogg", t = 0/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_magout.ogg", t = 8/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_maghit.ogg", t = 33/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_magin.ogg", t = 38/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_boltpull.ogg", t = 47/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_boltforward.ogg", t = 64/30},
			{s = path .. "wfoly_sh_aalpha12_reload_empty_fast_drum_end.ogg", t = 76/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.5},
			{hide = 1, t = 0.75},
        },
    ...
    ["inspect"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sh_aalpha12_inspect_03.ogg", t = 54/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_04.ogg", t = 65/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_05.ogg", t = 70/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_06.ogg", t = 109/30},
        },
    },
    ["inspect_drum"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sh_aalpha12_inspect_drum_raise.ogg", t = 3/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_drum_magout.ogg", t = 17/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_drum_mvmnt.ogg", t = 47/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_drum_magin.ogg", t = 61/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_drum_rotate.ogg", t = 81/30},
			{s = path .. "wfoly_sh_aalpha12_inspect_drum_end.ogg", t = 113/30},
        },
    },
    ["bash"] = {
