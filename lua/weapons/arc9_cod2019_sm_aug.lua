...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_augolf_reload_fast_magin_01.ogg", t = 0.86},
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_augolf_reload_empty_fast_waffle_chamber_01.ogg", t = 1.4},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_augolf_raise_first_chamber_01.ogg", t = 0.45},
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Category = {"cod2019_pistolgrip","cod2019_aug_grip"},
