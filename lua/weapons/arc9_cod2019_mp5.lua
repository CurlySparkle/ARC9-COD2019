...
SWEP.Trivia = {
    ...
    [ ARC9:GetPhrase("mw19_weight") ] = "2.54 kg",
...
SWEP.Animations = {
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_pi_mpapa5_reload_empty_boltclose_01.ogg", t = 43/30},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_pi_mpapa5_raise_first_closebolt_01.ogg", t = 16/30},
