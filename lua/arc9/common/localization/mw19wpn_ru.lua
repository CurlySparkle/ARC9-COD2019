...
L["mw19_caliber_792mauser"] = "7,92 мм \"Маузер\""
...
L["mw19_weapon_nade_claymore_desc"] = "Мина, взрывающаяся при приближении противника." .. quicknade
L["mw19_weapon_nade_frag_desc"] = "Боевая осколочная граната." .. quicknade
L["mw19_weapon_nade_molotov_desc"] = "Самодельная зажигательная бомба." .. quicknade
...
L["mw19_weapon_nade_c4_desc"] = "Крупный заряд, прилипающий к поверхностям. Для дистанционного подрыва нажмите {ATTACK} после окончания срока действия нажмите снаряжения." .. quicknade
L["mw19_weapon_nade_semtex_desc"] = "Граната-липдчка с таймером." .. quicknade
...
L["mw19_weapon_nade_smoke_desc"] = "Создает дымовую завесу, затрудняющую обзор." .. quicknade
L["mw19_weapon_nade_snapshot_desc"] = "Кратковременно показывает контуры противников в радиусе поражения." .. quicknade
L["mw19_weapon_nade_heartbeat_desc"] = "Планшет, показывающий примерное местоположение врагов неподалекд." .. quicknade
L["mw19_weapon_nade_stim_desc"] = "Армейский медицинский препарат, ускоряющий регенерацию ран и восстанавливающий силы для тактического бега." .. quicknade
L["mw19_weapon_nade_decoy_desc"] = "Граната, отвлекающая противника звуками перестрелки и фальшивыми радиолокационными сигнатурами." .. quicknade
L["mw19_weapon_nade_gas_desc"] = "Взрывается при столкновении с землей, испуская облако слезоточивого газа, который замедляет перемещение, ухудшает обзор и вызывает кашель в течение продолжительного времени." .. quicknade
