...
SWEP.WorldModel = "models/weapons/cod2019/w_rif_grau556.mdl"
...
SWEP.CustomizePos = Vector(10.5, 35, 3)
...
SWEP.TriggerDownSound = path .. "weap_sierra552_hammer_plr_01.ogg"
SWEP.TriggerUpSound = path .. "weap_sierra552_disconnector_plr_02.ogg"
...
SWEP.Animations = {
    ...
    ["reload_mmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_sierra552_reload_mmag_raise.ogg", t = 1/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_magout.ogg", t = 19/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_maghit.ogg", t = 33/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_magin.ogg", t = 41/30},
            {s = path .. "wfoly_ar_sierra552_reload_mmag_end.ogg", t = 57/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.4},
			{hide = 2, t = 1.825},
			{hide = 1, t = 2.4},
    ...
    ["reload_mmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_raise.ogg", t = 3/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_magout.ogg", t = 22/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_maghit.ogg", t = 36/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_magin.ogg", t = 47/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_arm.ogg", t = 55/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_charge.ogg", t = 67/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_empty_end.ogg", t = 73/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.4},
			{hide = 2, t = 1.13},
			{hide = 1, t = 2.8},
    ...
    ["reload_mmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_raise.ogg", t = 1/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_magout.ogg", t = 14/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_magin.ogg", t = 28/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_end.ogg", t = 40/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 1},
			{hide = 1, t = 1.7},
    ...
    ["reload_mmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_empty_raise.ogg", t = 3/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_empty_magout.ogg", t = 16/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_empty_maghit.ogg", t = 29/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_empty_magin.ogg", t = 35/30},
			{s = path .. "wfoly_ar_sierra552_raise_first_bolt_release.ogg", t = 44.5/30},
			{s = path .. "wfoly_ar_sierra552_reload_mmag_fast_empty_end.ogg", t = 46/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 1},
			{hide = 1, t = 1.675},
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_ar_sierra552_raise_first_bolt_release.ogg", t = 0.40},
