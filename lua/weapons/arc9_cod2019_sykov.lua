...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_pi_mike_first_raise_magin.ogg", t = 16/30},
			{s = path .. "wfoly_pi_mike_first_raise_end.ogg", t = 23/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
...
SWEP.Hook_TranslateAnimation = function (wep, anim)
    ...
    elseif anim == "inspect" and wep:HasElement("perk_speedreload") and wep:HasElement("mag_xmaglrg") then
        return "inspect_drum"
	--------------------------------------------------------------------------
