...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_plr_ar_kilo433_raise_first_open_01.ogg", t = 7/30},
			{s = path .. "wfoly_plr_ar_kilo433_raise_first_close_01.ogg", t = 24/30},
			{s = path .. "wfoly_plr_ar_kilo433_raise_first_end.ogg", t = 31/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
...
--------------------------------------------------------------------------
	...
	if anim == "inspect" and wep:HasElement("mag_drum") then
		return "inspect_drum"
	end
