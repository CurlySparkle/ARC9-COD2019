...
SWEP.CustomizePos = Vector(12, 27, 4)
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            {s = path .. "wfoly_sm_victor_raise_first_charge.ogg", t = 9/30},
			{s = path .. "wfoly_sm_victor_raise_first_end.ogg", t = 24/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Reciever",
        Category = "cod2019_vector_reciever",
