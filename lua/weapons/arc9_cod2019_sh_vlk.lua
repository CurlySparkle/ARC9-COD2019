...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_xmag_rotate.ogg", t = 1/30},
			{s = path .. "wfoly_sh_mark26_reload_xmag_magout.ogg", t = 11/30},
			{s = path .. "wfoly_sh_mark26_reload_xmag_magup.ogg", t = 34/30},
			{s = path .. "wfoly_sh_mark26_reload_xmag_magin_01.ogg", t = 45.5/30},
			{s = path .. "wfoly_sh_mark26_reload_xmag_magin_02.ogg", t = 53.5/30},            
			{s = path .. "wfoly_sh_mark26_reload_xmag_end.ogg", t = 64.5/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.7},
			{hide = 1, t = 1},
        },
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sh_mark26_reload_empty_rotate.ogg", t = 68/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_bolt_forward.ogg", t = 80/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_end.ogg", t = 94/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.95},
			{hide = 1, t = 1.25},
        },
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_rotate.ogg", t = 0},
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_magout.ogg", t = 5/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_arm_up.ogg", t = 24/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_magin_01.ogg", t = 32.5/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_magin_02.ogg", t = 41.5/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_xmag_end.ogg", t = 48/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.5},
			{hide = 1, t = 0.65},
        },
    ...
    ["reload_smag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_smag_rotate.ogg", t = 0/30},
			{s = path .. "wfoly_sh_mark26_reload_smag_magout.ogg", t = 11/30},
			{s = path .. "wfoly_sh_mark26_reload_smag_arm_up.ogg", t = 32/30},
			{s = path .. "wfoly_sh_mark26_reload_smag_maghit.ogg", t = 45/30},
			{s = path .. "wfoly_sh_mark26_reload_smag_magin.ogg", t = 56/30},
			{s = path .. "wfoly_sh_mark26_reload_smag_end.ogg", t = 56/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.7},
			{hide = 1, t = 0.9},
        },
    ...
    ["reload_smag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_bolt_pull.ogg", t = 0/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_up.ogg", t = 10/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_magout.ogg", t = 16.5/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_arm_up.ogg", t = 38.5/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_magin.ogg", t = 49.5/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_rotate.ogg", t = 75/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_bolt_forward.ogg", t = 82/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_smag_end.ogg", t = 94/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.95},
			{hide = 1, t = 1.25},
        },
    ...
    ["reload_smag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_rotate.ogg", t = 1/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_magout.ogg", t = 6/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_arm_up.ogg", t = 22/30},            
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_magin_01.ogg", t = 36.5/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_magin_02.ogg", t = 41.5/30},
			{s = path .. "wfoly_sh_mark26_reload_fast_smag_end.ogg", t = 51/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.55},
			{hide = 1, t = 0.7},
        },
    ...
    ["reload_smag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_bolt_pull.ogg", t = 0/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_magout.ogg", t = 10/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_arm_up.ogg", t = 31/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_magin_01.ogg", t = 41/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_magin_02.ogg", t = 50/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_rotate.ogg", t = 54/30},
			{s = path .. "wfoly_sh_mark26_reload_empty_fast_smag_bolt_forward.ogg", t = 68/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.7},
			{hide = 1, t = 0.9},
        },
