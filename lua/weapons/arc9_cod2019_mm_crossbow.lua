...
SWEP.ShootEnt = "arc9_cod2019_proj_arrow_base" -- Set to an entity to launch it out of this weapon.
...
SWEP.CustomizePos = Vector(16, 40, 5.5)
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_sn_crossbow_raise_first_safety_off.ogg", t = 0.275},
