...
SWEP.Description = [[A fully automatic bullpup assault rifle with a compact design that lends itself to close-quarter engagements.]]
...
SWEP.ShootSoundSilenced = "COD2019.RAM7.Silenced_Fire"
SWEP.ShootSoundIndoor = "COD2019.RAM7.Fire_Inside"
SWEP.ShootSoundSilencedIndoor = "COD2019.RAM7.Silenced_Fire_Inside"
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            {s = path .. "wfoly_ar_tango21_raise_first_up.ogg", t = 0/30},
            {s = path .. "wfoly_ar_tango21_raise_first_charge.ogg", t = 9/30},
			{s = path .. "wfoly_ar_tango21_raise_first_end.ogg", t = 24/30},
        },
    },
    ["draw"] = {
        Source = "draw_short",
    ...
    ["holster"] = {
		...
		Mult = 0.7,
        EventTable = {
            {s = path .. "wfoly_ar_tango21_reload_end.ogg", t = 0/30},
        },
    },
    ["idle"] = {
        Source = "idle",
