...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_smgolf45_reload_fast_magout.ogg", t = 10/30},
			{s = path .. "wfoly_sm_smgolf45_reload_fast_maghit.ogg", t = 19/30},
			{s = path .. "wfoly_sm_smgolf45_reload_fast_magin.ogg", t = 31/30},
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_smgolf45_reload_empty_fast_magout.ogg", t = 11/30},
			{s = path .. "wfoly_sm_smgolf45_reload_empty_fast_maghit.ogg", t = 27/30},
    ...
    ["ready"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_smgolf45_raise_first_bolt_pull.ogg", t = 9/30},
			{s = path .. "wfoly_sm_smgolf45_raise_first_bolt_release.ogg", t = 18/30},
