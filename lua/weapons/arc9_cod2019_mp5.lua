...
SWEP.MovingPos = Vector(-1, -0.5, -0.8)
...
SWEP.ShootSound = {path .. "weap_mpapa5_fire_plr_01.ogg", path .. "weap_mpapa5_fire_plr_02.ogg", path .. "weap_mpapa5_fire_plr_03.ogg", path .. "weap_mpapa5_fire_plr_04.ogg"}
SWEP.ShootSoundSilenced = {path .. "weap_mpapa5_fire_silenced_plr_01.ogg", path .. "weap_mpapa5_fire_silenced_plr_02.ogg", path .. "weap_mpapa5_fire_silenced_plr_03.ogg", path .. "weap_mpapa5_fire_silenced_plr_04.ogg"}
SWEP.ShootSoundIndoor = {path .. "weap_mpapa5_fire_plr_inside_01.ogg", path .. "weap_mpapa5_fire_plr_inside_02.ogg", path .. "weap_mpapa5_fire_plr_inside_03.ogg", path .. "weap_mpapa5_fire_plr_inside_04.ogg"}
SWEP.ShootSoundSilencedIndoor = {path .. "weap_mpapa5_fire_silenced_plr_inside_01.ogg", path .. "weap_mpapa5_fire_silenced_plr_inside_02.ogg", path .. "weap_mpapa5_fire_silenced_plr_inside_03.ogg", path .. "weap_mpapa5_fire_silenced_plr_inside_04.ogg"}
...
SWEP.Animations = {
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_sm_mpapa5_reload_empty_magin_v2_01.ogg", t = 31/30},
			{s = path .. "wfoly_sm_mpapa5_reload_empty_magin_v2_02.ogg", t = 38/30},
			{s = path .. "wfoly_pi_mpapa5_reload_empty_boltclose_01.ogg", t = 44/30},
			{s = path .. "wfoly_pi_mpapa5_reload_empty_end.ogg", t = 46/30},
        },
    },
    ["ready"] = {
        Source = "draw",
    ...
    ["switchsights"] = {
        Source = "semi_on",
        EventTable = {
            {s = path .. "wfoly_sm_mpapa5_inspect_02.ogg", t = 0/30},
        },
    },
}
