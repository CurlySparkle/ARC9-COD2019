...
//////////////////// Trivia
/////////// Caliber -- UO
L["mw19_caliber"] = "Калибр1"

L["mw19_caliber_7.62x39mm"] = "7,62×39 мм Soviet"
L["mw19_caliber_7.62x51mm"] = "7,62×51 мм"
L["mw19_caliber_5.56x45mm"] = "5,56×45 мм"
L["mw19_caliber_5.45x39mm"] = "5,45×39 мм"
L["mw19_caliber_12gauge"] = "12 Gauge"
L["mw19_caliber_50ae"] = ".50 AE"
L["mw19_caliber_5.7x28mm"] = "FN 5.7×28 мм"
L["mw19_caliber_4.6x30mm"] = "HK 4.6×30 мм"
L["mw19_caliber_9x19mm"] = "9×19 мм Parabellum"
L["mw19_caliber_.338"] = ".338 Lapua"
L["mw19_caliber_.308"] = ".308 Winchester"

/////////// Country of Origin -- UO
L["mw19_country"] = "Реальное название2"
...
/////////// Weapon Categories
L["mw19_category_weapon_ar"] = "Основное, Штурмовые винтовки"
L["mw19_category_weapon_smg"] = "Основное, Пистолеты-пулеметы"
L["mw19_category_weapon_shotgun"] = "Основное, Дробовики"
L["mw19_category_weapon_lmg"] = "Основное, Ручные пулеметы"
L["mw19_category_weapon_marksman"] = "Основное, Пехотные винтовки"
L["mw19_category_weapon_sniper"] = "Основное, Снайперские винтовки"
L["mw19_category_weapon_melee"] = "Дополнительное, Ближний Бой"
L["mw19_category_weapon_throwable"] = "Боевое снаряжение и Тактическое"

L["mw19_category_weapon_handgun"] = "Дополнительное, Пистолеты"
L["mw19_category_weapon_handgun_akimbo"] = "Дополнительное, Пистолеты (Парное)"
L["mw19_category_weapon_launcher"] = "Дополнительное, Пусковые установки"
...
//////////// Weapon Descriptions
L["mw19_weapon_kilo141_desc"] = "Автоматическая штдрмовая винтовка с эргономичным дизайном и умеренной скорострельностью, облегчающей поражение целей длинными очередями."
...
L["mw19_weapon_oden_desc"] = "Автоматическая боевая винтовка компоновки ”бдлл-пап”, использующая мощный патрон калибра 12,7х55 мм. Темп стрельбы намеренно снижен в целях повышения эргономичности."
...
L["mw19_weapon_scar_desc"] = "Крупнокалиберная полностью автоматическая штурмовая винтовка, позволяющая наносить высокий дрон на дальних дистанциях."
...
L["mw19_weapon_ram7_desc"] = "Автоматическая штурмовая винтовка. Благодаря компактной компоновке ”бдлл-пап” идеально подходит для ближнего боя."
L["mw19_weapon_grau_desc"] = "Это модульное орджие калибра 5,56 отличается малым весом, маневренностью и прекрасной дальнобойностью. Инженерная точность и доступность стволов мирового класса наделяют его исключительным потенциалом."
...
L["mw19_weapon_p90_desc"] = "Компактный пистолет-пдлемет компоновки ”бдлл-пап”. Расположенный сверху магазин заполнен сверхзвуковыми патронами калибра 5,7 х 28 мм."
L["mw19_weapon_mp5_desc"] = "Полностью автоматический пистолет-пдлемет калибра 9 мм. Идеальное соотношение стабильности, подвижности и убойности."
L["mw19_weapon_uzi_desc"] = "Автоматический пистолет-пдлемет со свободным затвором. Простая, надежная и эффективная конструкция."
L["mw19_weapon_pp19_desc"] = "Хорошо сбалансированный автоматический пистолет-пдлемет с магазином большой емкости."
L["mw19_weapon_mp7_desc"] = "Компактное полностью автоматическое оружие с высокой скорострельностью и низкой отдачей."
L["mw19_weapon_striker_desc"] = "Эффективный пистолет-пдлемет калибра .45, превосходящий аналогичное оружие по дальности поражения. Умеренная скорострельность позволяет лучше контролировать прицел при автоматической стрельбе."
L["mw19_weapon_fennec_desc"] = "Эффективный полностью автоматический пистолет-пдлемет с мягкой отдачей и впечатляющей скорострельностью, позволяющей моментально зачищать помещения и удерживать линию фронта."
L["mw19_weapon_iso_desc"] = "Изящный, скорострельный и полностью автоматический пистолет-пдлемет калибра 9 мм. это легкое и надежное оружие максимально эффективно на ближних дистанциях."
L["mw19_weapon_cx9_desc"] = "Этот пистолет-пдлемет со свободным затвором отличается не только высокой скорострельностью, но и отличной эргономикой, позволяющей бойцу быстро маневрировать в условиях ближнего боя."
...
L["mw19_weapon_sa87_desc"] = "Компактный ручной пулемет компоновки ”бдлл-пап”. Сочетание умеренной скорострельности и боеприпасов калибра 5,56 мм позволяет стабильно поражать цели на дальних дистанциях."
...
L["mw19_weapon_mg34_desc"] = "Полностью автоматическое орджие с высоким темпом стрельбы и дбойными патронами калибра 7,92 ”Мадзер” Оставшиеся со Второй мировой пулеметы все еще надежны и убийственны на поле боя."
...
L["mw19_weapon_kar98_desc"] = "Винтовка калибра 7,92 мм ”Мадзер” с продольно-скользящим затвором. Наследие Второй мировой, по-прежнему смертоносное в руках умелого стрелка."
...
L["mw19_weapon_spr_desc"] = "Надежная и убойная винтовка калибра .300 Винчестер с продольно-скользящим затвором от Sloan Precision. Благодаря популярности в использовании как в гражданских так и военных целях, это орджие обладает множеством возможностей для модификаций."
...
L["mw19_weapon_hdr_desc"] = "Крупнокалиберная снайперская винтовка калибра 12,7х108 мм с продольно-скользящим затвором. Пули весом 745 гран обладают невысокой начальной скоростью, но наносят чудовищный дрон даже при стрельбе с большой дистанции."
...
L["mw19_weapon_shield_desc"] = "Пуленепробиваемый и устойчивый ко взрывам щит с повышенным дроном в рукопашной."
...
L["mw19_weapon_deagle_desc"] = "Самый мощный полдавтоматический пистолет, доступный на рынке. Наносит значительный дрон на ближних и средних дистанциях."
...
L["mw19_weapon_nade_proximity_desc"] = "Взрывается при контакте и наносит значительный дрон транспорту."
