...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sh_oscar12_reload_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_xmag_magout_01.ogg", t = 20/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_xmag_magin_01.ogg", t = 34/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_xmag_arm.ogg", t = 47/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_xmag_end.ogg", t = 58/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.4},
			{hide = 2, t = 1.8},
			{hide = 1, t = 2.26},
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_magout_01.ogg", t = 9/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_tilt.ogg", t = 21/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_magin_01.ogg", t = 29/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_arm.ogg", t = 44/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_grab.ogg", t = 61/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_charge_01.ogg", t = 74/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_xmag_end.ogg", t = 75/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.65},
			{hide = 1, t = 3.13},
        },
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sh_oscar12_reload_fast_xmag_start.ogg", t = 1/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_fast_xmag_magout_01.ogg", t = 16/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_fast_xmag_magin_01.ogg", t = 26/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_fast_xmag_end.ogg", t = 43/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.3},
			{hide = 2, t = 1.4},
			{hide = 1, t = 1.96},
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_start.ogg", t = 0/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_magout_01.ogg", t = 7/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_arm.ogg", t = 19/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_magin_01.ogg", t = 27/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_charge_01.ogg", t = 40/30},
			{s = path .. "wfoly_plr_sh_oscar12_reload_empty_fast_xmag_end.ogg", t = 42/30},
			{hide = 1, t = 0},
			{hide = 2, t = 0.65},
			{hide = 1, t = 2.035},
        },
