...
SWEP.WorldModelOffset = {
	...
	TPIKPosSightOffset = Vector(2, 2, -2),
}
...
SWEP.CustomizePos = Vector(15.5, 40, 3)
SWEP.CustomizeRotateAnchor = Vector(15.5, -3.5, -4)
...
SWEP.TriggerDownSound = path .. "wfoly_sn_remeo700_hammer_plr_01.ogg"
SWEP.TriggerUpSound = path .. "wfoly_sn_remeo700_disconnector_plr_01.ogg"
...
SWEP.CodStubbyGripPoseParam = 31.9
