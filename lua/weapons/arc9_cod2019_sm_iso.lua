...
SWEP.Animations = {
    ...
    ["reload_xmag"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_charlie9_reload_xmag_up.ogg", t = 2/30},
			{s = path .. "wfoly_sm_charlie9_reload_xmag_arm.ogg", t = 21/30},
			{s = path .. "wfoly_sm_charlie9_reload_xmag_magout.ogg", t = 28/30},
			{s = path .. "wfoly_sm_charlie9_reload_xmag_magin.ogg", t = 44/30},
			{s = path .. "wfoly_sm_charlie9_reload_xmag_end.ogg", t = 58/30},
			{hide = 1, t = 0},
			{hide = 0, t = 0.4},
			{hide = 2, t = 1.75},
			{hide = 1, t = 2.2},
    ...
    ["reload_xmag_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_shake.ogg", t = 1/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_magout.ogg", t = 9/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_arm.ogg", t = 28/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_maghit.ogg", t = 37/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_magin.ogg", t = 42/30},
            {s = path .. "wfoly_sm_charlie9_reload_empty_xmag_mvmnt.ogg", t = 51/30},
            {s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_bolt_release.ogg", t = 56/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_xmag_end.ogg", t = 66/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.55},
			{hide = 2, t = 0.8},
			{hide = 1, t = 2.2},
    ...
    ["reload_xmag_fast"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_charlie9_reload_fast_xmag_up.ogg", t = 1/30},
			{s = path .. "wfoly_sm_charlie9_reload_fast_xmag_magout.ogg", t = 7/30},
			{s = path .. "wfoly_sm_charlie9_reload_fast_xmag_arm.ogg", t = 16/30},
			{s = path .. "wfoly_sm_charlie9_reload_fast_xmag_magin.ogg", t = 24/30},
			{s = path .. "wfoly_sm_charlie9_reload_fast_xmag_end.ogg", t = 38/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.43},
			{hide = 1, t = 0.475},
        },
    ...
    ["reload_xmag_fast_empty"] = {
        ...
        EventTable = {
			{s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_up.ogg", t = 4/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_magout.ogg", t = 7/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_magin.ogg", t = 23/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_bolt_release.ogg", t = 32/30},
			{s = path .. "wfoly_sm_charlie9_reload_empty_fast_xmag_end.ogg", t = 40/30},
			{hide = 1, t = 0},
			{hide = 3, t = 0.43},
			{hide = 1, t = 0.475},
        },
