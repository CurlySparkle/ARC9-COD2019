AddCSLuaFile()
if CLIENT then
    killicon.Add( "arc9_cod2019_50gs", "vgui/killicons/cod2019_pi_50gs.png", Color(251, 85, 25, 255))
end
...
SWEP.Trivia = {
    ...
    [ ARC9:GetPhrase("mw19_caliber") ] = ".50 Action Express",
    [ ARC9:GetPhrase("mw19_weight") ] = "2 kg",
    [ ARC9:GetPhrase("mw19_weight_projectile") ] = "300 gr",
