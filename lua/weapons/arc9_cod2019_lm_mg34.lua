...
SWEP.WorldModelOffset = {
    Pos = Vector(-3.5, 4.75, -7),
    Ang = Angle(-5, 0, 180),
    TPIKPos = Vector(-6.5, 4.5, -4),
...
SWEP.CustomizePos = Vector(17, 42.5, 4.5)
SWEP.CustomizeRotateAnchor = Vector(17, -3.5, -4)
SWEP.CustomizeSnapshotFOV = 65
SWEP.CustomizeSnapshotPos = Vector(0, 55, 0)
SWEP.CustomizeSnapshotAng = Angle(0, 0, 0)
SWEP.CustomizeNoRotate = false

SWEP.PeekPos = Vector(-1.5, 2, -4.5)
