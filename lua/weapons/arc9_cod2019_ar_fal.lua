...
SWEP.Trivia = {
    ...
    [ ARC9:GetPhrase("mw19_weight") ] = "4.45 kg",
...
SWEP.Animations = {
    ...
    ["reload_fast"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_falima_reload_fast_magin_v2_01.ogg", t = 0.73},
			{s = path .. "wfoly_plr_ar_falima_reload_fast_magin_v2_02.ogg", t = 1.3},
    ...
    ["reload_fast_empty"] = {
        ...
        EventTable = {
			...
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_elbow.ogg", t = 1.46},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_magin_v2_01.ogg", t = 1.66},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_magin_v2_02.ogg", t = 1.86},
			{s = path .. "wfoly_plr_ar_falima_reload_empty_fast_charge_01.ogg", t = 2.16},
